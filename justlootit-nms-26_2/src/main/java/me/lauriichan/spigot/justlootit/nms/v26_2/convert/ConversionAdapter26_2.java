...
import me.lauriichan.spigot.justlootit.nms.v26_2.VersionHandler26_2;
...
public final class ConversionAdapter26_2 extends ConversionAdapter {
    ...
    static final CraftPersistentDataTypeRegistry DATA_TYPE_REGISTRY = NmsHelper26_2.dataTypeRegistry();

    private final ISimpleLogger logger;

    public ConversionAdapter26_2(VersionHandler26_2 handler) {
    ...
    public ObjectList<ProtoWorld26_2> getWorlds(File directory) {
        ...
        return ObjectList
            .of(new ProtoWorld26_2(workerPool(logger), logger, session, closeSession, dimensionKey, levelData.worldDataAndGenSettings()));
    }
