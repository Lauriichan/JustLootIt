...
public final class CompoundTag26_2 implements ICompoundTag {

    private final CompoundTag compoundTag;

    public CompoundTag26_2() {
        this(new CompoundTag());
    }

    public CompoundTag26_2(CompoundTag compoundTag) {
    ...
    public ICompoundTag getCompound(String key) {
        ...
        return new CompoundTag26_2((CompoundTag) tag);
    }
    ...
    public IListTag<?> getList(String key) {
        ...
        return new ListTag26_2<>(listTag, TagType.getType(listTag.identifyRawElementType()));
    }
    ...
    public <T> IListTag<T> getList(String key, TagType<T> type) {
        ...
        if (listType == 0 || listType == type.tagId()) {
            return new ListTag26_2<>(listTag, type);
        }
        return null;
    }
    ...
    public void set(String key, ICompoundTag compound) {
        compoundTag.put(key, ((CompoundTag26_2) compound).handle());
    }

    @Override
    public void set(String key, IListTag<?> list) {
        compoundTag.put(key, ((ListTag26_2<?>) list).handle());
    }
    ...
    @Override
    public void clear() {
        NmsHelper26_2.clearCompound(compoundTag);
    }
