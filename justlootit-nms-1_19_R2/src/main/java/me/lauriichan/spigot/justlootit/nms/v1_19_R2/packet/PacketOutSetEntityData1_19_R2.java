...
public class PacketOutSetEntityData1_19_R2 extends PacketOutSetEntityData {
    ...
    public PacketOutSetEntityData1_19_R2(final ClientboundSetEntityDataPacket packet) {
        this.packet = packet;
    ...
    private static class EntityDataPack implements IEntityDataPack {
        ...
        public EntityDataPack(final List<DataValue<?>> values) {
            ...
            for (final DataValue<?> value : values) {
                final EntityData1_19_R2 data = EntityData1_19_R2.create(value);
                if (data instanceof ItemEntityData1_19_R2) {
                    dataValues.add(new ItemData(this, (ItemEntityData1_19_R2) data));
                    continue;
                }
                dataValues.add(data);
            }
        ...
        private static class ItemData implements IItemEntityData {
            ...
            private final ItemEntityData1_19_R2 data;

            public ItemData(final EntityDataPack pack, final ItemEntityData1_19_R2 data) {
                this.pack = pack;
                this.data = data;
            }
