...
import me.lauriichan.spigot.justlootit.nms.v1_21_R2.PlayerAdapter1_21_R2;
import net.minecraft.network.protocol.Packet;

public class PlayerNetwork1_21_R2 implements IPlayerNetwork {

    private final PacketManager1_21_R2 packetManager;

    private final PacketInHandler1_21_R2 packetIn = new PacketInHandler1_21_R2(this);
    private final PacketOutHandler1_21_R2 packetOut = new PacketOutHandler1_21_R2(this);

    private final PlayerAdapter1_21_R2 player;

    private boolean active = true;

    public PlayerNetwork1_21_R2(final PacketManager1_21_R2 packetManager, final PlayerAdapter1_21_R2 player) {
