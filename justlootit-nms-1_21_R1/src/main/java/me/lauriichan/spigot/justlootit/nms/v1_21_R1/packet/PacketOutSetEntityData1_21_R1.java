package me.lauriichan.spigot.justlootit.nms.v1_21_R1.packet;
...
import me.lauriichan.spigot.justlootit.nms.v1_21_R1.model.EntityData1_21_R1;
import me.lauriichan.spigot.justlootit.nms.v1_21_R1.model.ItemEntityData1_21_R1;
...
public class PacketOutSetEntityData1_21_R1 extends PacketOutSetEntityData {
    ...
    public PacketOutSetEntityData1_21_R1(final ClientboundSetEntityDataPacket packet) {
        this.packet = packet;
        this.data = new EntityDataPack(packet.packedItems());
    }

    public PacketOutSetEntityData1_21_R1(final ArgumentMap map) {
    ...
    private static class EntityDataPack implements IEntityDataPack {
        ...
        public EntityDataPack(final List<DataValue<?>> values) {
            ...
            for (final DataValue<?> value : values) {
                final EntityData1_21_R1 data = EntityData1_21_R1.create(value);
                if (data instanceof ItemEntityData1_21_R1) {
                    dataValues.add(new ItemData(this, (ItemEntityData1_21_R1) data));
                    continue;
                }
                dataValues.add(data);
            }
        ...
        private static class ItemData implements IItemEntityData {
            ...
            private final ItemEntityData1_21_R1 data;

            public ItemData(final EntityDataPack pack, final ItemEntityData1_21_R1 data) {
                this.pack = pack;
                this.data = data;
            }
