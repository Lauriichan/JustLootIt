...
import me.lauriichan.spigot.justlootit.nms.v1_21_R1.network.PlayerNetwork1_21_R1;
import me.lauriichan.spigot.justlootit.nms.v1_21_R1.util.MinecraftConstant1_21_R1;
...
public final class PlayerAdapter1_21_R1 extends PlayerAdapter {
    ...
    public PlayerAdapter1_21_R1(final VersionHandler1_21_R1 versionHandler, final Player player) {
        super(player.getUniqueId());
        this.bukkit = (CraftPlayer) player;
        this.minecraft = bukkit.getHandle();
        this.network = new PlayerNetwork1_21_R1(versionHandler.packetManager(), this);
    ...
    @Override
    public PlayerNetwork1_21_R1 getNetwork() {
        return network;
    }
