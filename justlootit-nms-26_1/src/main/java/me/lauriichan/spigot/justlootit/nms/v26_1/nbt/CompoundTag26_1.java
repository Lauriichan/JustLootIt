...
public final class CompoundTag26_1 implements ICompoundTag {

    private final CompoundTag compoundTag;

    public CompoundTag26_1() {
        this(new CompoundTag());
    }

    public CompoundTag26_1(CompoundTag compoundTag) {
    ...
    public ICompoundTag getCompound(String key) {
        ...
        return new CompoundTag26_1((CompoundTag) tag);
    }
    ...
    public IListTag<?> getList(String key) {
        ...
        return new ListTag26_1<>(listTag, TagType.getType(listTag.identifyRawElementType()));
    }
    ...
    public <T> IListTag<T> getList(String key, TagType<T> type) {
        ...
        if (listType == 0 || listType == type.tagId()) {
            return new ListTag26_1<>(listTag, type);
        }
        return null;
    }
    ...
    public void set(String key, ICompoundTag compound) {
        compoundTag.put(key, ((CompoundTag26_1) compound).handle());
    }

    @Override
    public void set(String key, IListTag<?> list) {
        compoundTag.put(key, ((ListTag26_1<?>) list).handle());
    }
    ...
    @Override
    public void clear() {
        NmsHelper26_1.clearCompound(compoundTag);
    }
