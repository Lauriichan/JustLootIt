package me.lauriichan.spigot.justlootit.nms.v26_1.packet;
...
import me.lauriichan.spigot.justlootit.nms.v26_1.model.EntityData26_1;
import me.lauriichan.spigot.justlootit.nms.v26_1.model.ItemEntityData26_1;
import net.minecraft.network.protocol.game.ClientboundSetEntityDataPacket;
import net.minecraft.network.syncher.SynchedEntityData;
import net.minecraft.network.syncher.SynchedEntityData.DataItem;
import net.minecraft.network.syncher.SynchedEntityData.DataValue;

public class PacketOutSetEntityData26_1 extends PacketOutSetEntityData {
    ...
    public PacketOutSetEntityData26_1(final ClientboundSetEntityDataPacket packet) {
        this.packet = packet;
        this.data = new EntityDataPack(packet.packedItems());
    }

    public PacketOutSetEntityData26_1(final ArgumentMap map) {
    ...
    private static class EntityDataPack implements IEntityDataPack {
        ...
        public EntityDataPack(final List<DataValue<?>> values) {
            ...
            for (final DataValue<?> value : values) {
                final EntityData26_1 data = EntityData26_1.create(value);
                if (data instanceof ItemEntityData26_1) {
                    dataValues.add(new ItemData(this, (ItemEntityData26_1) data));
                    continue;
                }
                dataValues.add(data);
            }
        ...
        private static class ItemData implements IItemEntityData {
            ...
            private final ItemEntityData26_1 data;

            public ItemData(final EntityDataPack pack, final ItemEntityData26_1 data) {
                this.pack = pack;
                this.data = data;
            }
