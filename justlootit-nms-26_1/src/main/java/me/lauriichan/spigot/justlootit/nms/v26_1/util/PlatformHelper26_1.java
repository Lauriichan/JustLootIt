package me.lauriichan.spigot.justlootit.nms.v26_1.util;
...
public final class PlatformHelper26_1 {
    ...
    private static final class Access {
        ...
        static MethodHandle getUpgradeChunkTag() {
            Method method = ClassUtil.getMethod(SimpleRegionStorage.class, "upgradeChunkTag", CompoundTag.class, int.class,
                CompoundTag.class, int.class, LevelAccessor.class);
    ...
    public static CompoundTag upgradeChunkTag(SimpleRegionStorage storage, CompoundTag chunkTag, int fallbackVersion,
        ...
        try {
            return storage.upgradeChunkTag(chunkTag, fallbackVersion, contextTag,
                SharedConstants.getCurrentVersion().dataVersion().version(), pos, null);
        } catch (NoSuchMethodError err) {
            try {
                return (CompoundTag) UPGRADE_CHUNK_TAG.invoke(storage, chunkTag, fallbackVersion, contextTag,
                    SharedConstants.getCurrentVersion().dataVersion().version(), null);
            } catch (Throwable e) {
