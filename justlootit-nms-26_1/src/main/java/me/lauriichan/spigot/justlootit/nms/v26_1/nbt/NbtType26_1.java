...
public final class NbtType26_1<P, C extends Tag> {

    private static final Int2ObjectMap<NbtType26_1<?, ?>> TYPES;

    static {
        Int2ObjectArrayMap<NbtType26_1<?, ?>> map = new Int2ObjectArrayMap<>(12);
        ...
        create(map, TagType.LIST, ListTag.class, tag -> new ListTag26_1<>(tag, TagType.getType(tag.getId())), tag -> ((ListTag26_1<?>) tag).handle());
        create(map, TagType.COMPOUND, CompoundTag.class, CompoundTag26_1::new, tag -> ((CompoundTag26_1) tag).handle());
    ...
    private static <P, C extends Tag> void create(Int2ObjectMap<NbtType26_1<?, ?>> map, TagType<P> type, Class<C> complexType,
        Function<C, P> complexToPrimitive, Function<P, C> primitiveToComplex) {
        map.put(type.tagId(), new NbtType26_1<>(type, complexType, complexToPrimitive, primitiveToComplex));
    }

    @SuppressWarnings("unchecked")
    public static <T> NbtType26_1<T, ?> get(TagType<T> type) {
        return (NbtType26_1<T, ?>) TYPES.get(type.tagId());
    }
    ...
    private NbtType26_1(TagType<P> type, Class<C> complexType, Function<C, P> complexToPrimitive, Function<P, C> primitiveToComplex) {
        this.type = type;
