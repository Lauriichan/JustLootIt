...
public final class ListTag1_21_R7<T> implements IListTag<T> {

    private static final class SimpleIterator<T> implements Iterator<T> {

        private final ListTag1_21_R7<T> tag;
        private volatile int index;

        public SimpleIterator(final ListTag1_21_R7<T> tag) {
            this.tag = tag;
        }
    ...
    private final NbtType1_21_R7<T, ?> type;

    public ListTag1_21_R7(TagType<T> type) {
        this(new ListTag(), type);
    }

    public ListTag1_21_R7(ListTag listTag, TagType<T> type) {
        this.listTag = listTag;
        this.type = NbtType1_21_R7.get(type);
    }
