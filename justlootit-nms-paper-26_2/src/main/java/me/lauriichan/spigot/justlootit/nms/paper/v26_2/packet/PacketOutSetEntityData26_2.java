package me.lauriichan.spigot.justlootit.nms.paper.v26_2.packet;
...
import me.lauriichan.spigot.justlootit.nms.paper.v26_2.model.EntityData26_2;
import me.lauriichan.spigot.justlootit.nms.paper.v26_2.model.ItemEntityData26_2;
...
public class PacketOutSetEntityData26_2 extends PacketOutSetEntityData {
    ...
    public PacketOutSetEntityData26_2(final ClientboundSetEntityDataPacket packet) {
        this.packet = packet;
        this.data = new EntityDataPack(packet.packedItems());
    }

    public PacketOutSetEntityData26_2(final ArgumentMap map) {
    ...
    private static class EntityDataPack implements IEntityDataPack {
        ...
        public EntityDataPack(final List<DataValue<?>> values) {
            ...
            for (final DataValue<?> value : values) {
                final EntityData26_2 data = EntityData26_2.create(value);
                if (data instanceof ItemEntityData26_2) {
                    dataValues.add(new ItemData(this, (ItemEntityData26_2) data));
                    continue;
                }
                dataValues.add(data);
            }
        ...
        private static class ItemData implements IItemEntityData {
            ...
            private final ItemEntityData26_2 data;

            public ItemData(final EntityDataPack pack, final ItemEntityData26_2 data) {
                this.pack = pack;
                this.data = data;
            }
