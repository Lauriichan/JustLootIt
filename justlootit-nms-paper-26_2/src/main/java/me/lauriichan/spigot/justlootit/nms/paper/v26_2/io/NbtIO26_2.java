package me.lauriichan.spigot.justlootit.nms.paper.v26_2.io;
...
public abstract class NbtIO26_2<E, N extends Tag> extends IOHandler<E> {
    ...
    public NbtIO26_2(final Class<E> type, final TagType<N> tagType) {
        super(type);
