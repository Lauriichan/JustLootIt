...
public final class ItemStackIO26_2 extends NbtIO26_2<org.bukkit.inventory.ItemStack, CompoundTag> {

    public static final ItemStackIO26_2 ITEM_STACK = new ItemStackIO26_2();
    ...
    private final Frozen registry = NmsHelper26_2.getServer().registryAccess();

    private ItemStackIO26_2() {
