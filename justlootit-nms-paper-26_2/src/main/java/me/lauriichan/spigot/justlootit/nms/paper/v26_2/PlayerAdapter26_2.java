...
import me.lauriichan.spigot.justlootit.nms.paper.v26_2.network.PlayerNetwork26_2;
import me.lauriichan.spigot.justlootit.nms.paper.v26_2.util.MinecraftConstant26_2;
...
public final class PlayerAdapter26_2 extends PlayerAdapter {
    ...
    public PlayerAdapter26_2(final VersionHandler26_2 versionHandler, final Player player) {
        super(player.getUniqueId());
        this.bukkit = (CraftPlayer) player;
        this.minecraft = bukkit.getHandle();
        this.network = new PlayerNetwork26_2(versionHandler.packetManager(), this);
    ...
    @Override
    public PlayerNetwork26_2 getNetwork() {
        return network;
    }
    ...
    public int createAnvilMenu(final String name, final ItemStack itemStack) {
        ...
        final AnvilMenu menu = new AnvilMenu(minecraft.nextContainerCounter(), minecraft.getInventory(),
            MinecraftConstant26_2.BETTER_NULL);
