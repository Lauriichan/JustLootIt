package me.lauriichan.spigot.justlootit.nms.v1_21_R4.io;
...
public final class ItemStackIO1_21_R4 extends NbtIO1_21_R4<org.bukkit.inventory.ItemStack, CompoundTag> {

    public static final ItemStackIO1_21_R4 ITEM_STACK = new ItemStackIO1_21_R4();
    ...
    private final Frozen registry = NmsHelper1_21_R4.getServer().registryAccess();

    private ItemStackIO1_21_R4() {
    ...
    public org.bukkit.inventory.ItemStack fromNbt(final CompoundTag tag) {
        return CraftItemStack.asCraftMirror(tag.isEmpty() ? ItemStack.EMPTY : ItemStack.parse(registry, tag).orElse(ItemStack.EMPTY));
    }
