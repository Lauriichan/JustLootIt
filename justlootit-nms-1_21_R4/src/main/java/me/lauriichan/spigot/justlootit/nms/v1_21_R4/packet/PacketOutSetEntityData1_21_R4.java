package me.lauriichan.spigot.justlootit.nms.v1_21_R4.packet;
...
import me.lauriichan.spigot.justlootit.nms.v1_21_R4.model.EntityData1_21_R4;
import me.lauriichan.spigot.justlootit.nms.v1_21_R4.model.ItemEntityData1_21_R4;
import net.minecraft.network.protocol.game.ClientboundSetEntityDataPacket;
import net.minecraft.network.syncher.SynchedEntityData;
import net.minecraft.network.syncher.SynchedEntityData.DataItem;
import net.minecraft.network.syncher.SynchedEntityData.DataValue;

public class PacketOutSetEntityData1_21_R4 extends PacketOutSetEntityData {
    ...
    public PacketOutSetEntityData1_21_R4(final ClientboundSetEntityDataPacket packet) {
        this.packet = packet;
        this.data = new EntityDataPack(packet.packedItems());
    }

    public PacketOutSetEntityData1_21_R4(final ArgumentMap map) {
    ...
    private static class EntityDataPack implements IEntityDataPack {
        ...
        public EntityDataPack(final List<DataValue<?>> values) {
            ...
            for (final DataValue<?> value : values) {
                final EntityData1_21_R4 data = EntityData1_21_R4.create(value);
                if (data instanceof ItemEntityData1_21_R4) {
                    dataValues.add(new ItemData(this, (ItemEntityData1_21_R4) data));
                    continue;
                }
                dataValues.add(data);
            }
        ...
        private static class ItemData implements IItemEntityData {
            ...
            private final ItemEntityData1_21_R4 data;

            public ItemData(final EntityDataPack pack, final ItemEntityData1_21_R4 data) {
                this.pack = pack;
                this.data = data;
            }
