...
public final class NbtHelper1_21_R4 extends NbtHelper {
    ...
    public ICompoundTag getCustomDataTag(ItemStack itemStack) {
        ...
        CompoundTag tag = NmsHelper1_21_R4.getCustomData(itemStack.getItemMeta());
        if (tag == null) {
            NmsHelper1_21_R4.setCustomData(meta, tag = new CompoundTag());
        }
        return new CompoundTag1_21_R4(tag);
    }
