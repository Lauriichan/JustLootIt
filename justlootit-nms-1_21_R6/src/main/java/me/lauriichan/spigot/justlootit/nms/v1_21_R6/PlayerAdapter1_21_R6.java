...
import me.lauriichan.spigot.justlootit.nms.v1_21_R6.network.PlayerNetwork1_21_R6;
import me.lauriichan.spigot.justlootit.nms.v1_21_R6.util.MinecraftConstant1_21_R6;
...
public final class PlayerAdapter1_21_R6 extends PlayerAdapter {
    ...
    private final VersionHandler1_21_R6 versionHandler;
    private final PlayerNetwork1_21_R6 network;

    private final CraftPlayer bukkit;
    private final ServerPlayer minecraft;

    public PlayerAdapter1_21_R6(final VersionHandler1_21_R6 versionHandler, final Player player) {
        super(player.getUniqueId());
        this.bukkit = (CraftPlayer) player;
        this.minecraft = bukkit.getHandle();
        this.network = new PlayerNetwork1_21_R6(versionHandler.packetManager(), this);
    ...
    @Override
    public VersionHandler1_21_R6 versionHandler() {
        return versionHandler;
    }

    @Override
    public PlayerNetwork1_21_R6 getNetwork() {
        return network;
    }
    ...
    public int createAnvilMenu(final String name, final ItemStack itemStack) {
        ...
        final AnvilMenu menu = new AnvilMenu(minecraft.nextContainerCounter(), minecraft.getInventory(),
            MinecraftConstant1_21_R6.BETTER_NULL);
    ...
    public int getPermissionLevel() {
        return minecraft.server.getProfilePermissions(minecraft.nameAndId());
    }
