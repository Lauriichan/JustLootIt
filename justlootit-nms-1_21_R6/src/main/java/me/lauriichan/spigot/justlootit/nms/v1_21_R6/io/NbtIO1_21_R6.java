package me.lauriichan.spigot.justlootit.nms.v1_21_R6.io;
...
public abstract class NbtIO1_21_R6<E, N extends Tag> extends IOHandler<E> {
    ...
    public NbtIO1_21_R6(final Class<E> type, final TagType<N> tagType) {
        super(type);
