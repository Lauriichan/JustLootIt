...
public class Direction {
     ...
     */
    public Direction(final float xRotation, final float yRotation) {
    ...
    public Vertical calculateVertical() {
        ...
        if (yRotation < -25f && yRotation >= -75f) {
    ...
    public Horizontal calculateHorizontal() {
        ...
        if (xRotation > -33.75f && xRotation <= -11.25f) {
    ...
    public void setRotationX(final float xRotation) {
    ...
    public void setRotationY(final float yRotation) {
