...
public final class Messages implements IMessageExtension {
    ...
    @Message(id = "container.access.unpermitted", content = "&cYou are not permitted to access this container.")
    public static MessageProvider CONTAINER_ACCESS_UNPERMITTED;
