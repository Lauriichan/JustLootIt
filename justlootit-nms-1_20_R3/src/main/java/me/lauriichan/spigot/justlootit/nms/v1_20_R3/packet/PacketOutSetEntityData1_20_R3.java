...
import me.lauriichan.spigot.justlootit.nms.v1_20_R3.model.EntityData1_20_R3;
import me.lauriichan.spigot.justlootit.nms.v1_20_R3.model.ItemEntityData1_20_R3;
import net.minecraft.network.protocol.game.ClientboundSetEntityDataPacket;
import net.minecraft.network.syncher.SynchedEntityData;
import net.minecraft.network.syncher.SynchedEntityData.DataItem;
import net.minecraft.network.syncher.SynchedEntityData.DataValue;

public class PacketOutSetEntityData1_20_R3 extends PacketOutSetEntityData {
    ...
    public PacketOutSetEntityData1_20_R3(final ClientboundSetEntityDataPacket packet) {
        this.packet = packet;
        this.data = new EntityDataPack(packet.packedItems());
    }

    public PacketOutSetEntityData1_20_R3(final ArgumentMap map) {
    ...
    private static class EntityDataPack implements IEntityDataPack {
        ...
        public EntityDataPack(final List<DataValue<?>> values) {
            ...
            for (final DataValue<?> value : values) {
                final EntityData1_20_R3 data = EntityData1_20_R3.create(value);
                if (data instanceof ItemEntityData1_20_R3) {
                    dataValues.add(new ItemData(this, (ItemEntityData1_20_R3) data));
                    continue;
                }
                dataValues.add(data);
            }
        ...
        private static class ItemData implements IItemEntityData {
            ...
            private final ItemEntityData1_20_R3 data;

            public ItemData(final EntityDataPack pack, final ItemEntityData1_20_R3 data) {
                this.pack = pack;
                this.data = data;
            }
