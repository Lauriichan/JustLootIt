...
public class PlayerNetwork1_20_R3 implements IPlayerNetwork {

    private final PacketManager1_20_R3 packetManager;

    private final PacketInHandler1_20_R3 packetIn = new PacketInHandler1_20_R3(this);
    private final PacketOutHandler1_20_R3 packetOut = new PacketOutHandler1_20_R3(this);

    private final PlayerAdapter1_20_R3 player;

    private boolean active = true;

    public PlayerNetwork1_20_R3(final PacketManager1_20_R3 packetManager, final PlayerAdapter1_20_R3 player) {
