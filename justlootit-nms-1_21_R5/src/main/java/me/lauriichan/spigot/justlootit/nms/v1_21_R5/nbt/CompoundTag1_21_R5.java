...
public final class CompoundTag1_21_R5 implements ICompoundTag {

    private final CompoundTag compoundTag;

    public CompoundTag1_21_R5() {
        this(new CompoundTag());
    }

    public CompoundTag1_21_R5(CompoundTag compoundTag) {
    ...
    public ICompoundTag getCompound(String key) {
        ...
        return new CompoundTag1_21_R5((CompoundTag) tag);
    }
    ...
    public IListTag<?> getList(String key) {
        ...
        return new ListTag1_21_R5<>(listTag, TagType.getType(listTag.identifyRawElementType()));
    }
    ...
    public <T> IListTag<T> getList(String key, TagType<T> type) {
        ...
        if (listType == 0 || listType == type.tagId()) {
            return new ListTag1_21_R5<>(listTag, type);
        }
        return null;
    }
    ...
    public void set(String key, ICompoundTag compound) {
        compoundTag.put(key, ((CompoundTag1_21_R5) compound).handle());
    }

    @Override
    public void set(String key, IListTag<?> list) {
        compoundTag.put(key, ((ListTag1_21_R5<?>) list).handle());
    }
    ...
    @Override
    public void clear() {
        NmsHelper1_21_R5.clearCompound(compoundTag);
    }
