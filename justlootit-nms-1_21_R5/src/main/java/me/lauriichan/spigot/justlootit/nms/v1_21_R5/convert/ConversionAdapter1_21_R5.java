...
import me.lauriichan.spigot.justlootit.nms.v1_21_R5.VersionHandler1_21_R5;
...
public final class ConversionAdapter1_21_R5 extends ConversionAdapter {

    static final CraftPersistentDataTypeRegistry DATA_TYPE_REGISTRY = NmsHelper1_21_R5.dataTypeRegistry();

    private final ISimpleLogger logger;
    private final VersionHandler1_21_R5 handler;

    public ConversionAdapter1_21_R5(VersionHandler1_21_R5 handler) {
        this.logger = handler.logger();
        this.handler = handler;
    }

    @Override
    public ProtoWorld1_21_R5 getWorld(File directory) {
        ...
        MinecraftServer server = NmsHelper1_21_R5.getServer();
        ...
        return handler.applyCapabilities(new ProtoWorld1_21_R5(workerPool(logger), logger,
