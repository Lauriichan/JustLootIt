...
public final class NbtHelper1_21_R3 extends NbtHelper {
    ...
    public ICompoundTag getCustomDataTag(ItemStack itemStack) {
        ...
        CompoundTag tag = NmsHelper1_21_R3.getCustomData(itemStack.getItemMeta());
        if (tag == null) {
            NmsHelper1_21_R3.setCustomData(meta, tag = new CompoundTag());
        }
        return new CompoundTag1_21_R3(tag);
    }
