...
public final class ListTag1_21_R3<T> implements IListTag<T> {

    private static final class SimpleIterator<T> implements Iterator<T> {

        private final ListTag1_21_R3<T> tag;
        private volatile int index;

        public SimpleIterator(final ListTag1_21_R3<T> tag) {
            this.tag = tag;
        }
    ...
    private final NbtType1_21_R3<T, ?> type;

    public ListTag1_21_R3(TagType<T> type) {
        this(new ListTag(), type);
    }

    public ListTag1_21_R3(ListTag listTag, TagType<T> type) {
        this.listTag = listTag;
        this.type = NbtType1_21_R3.get(type);
    }
