...
import me.lauriichan.spigot.justlootit.nms.v1_20_R4.network.PlayerNetwork1_20_R4;
import me.lauriichan.spigot.justlootit.nms.v1_20_R4.util.MinecraftConstant1_20_R4;
...
public final class PlayerAdapter1_20_R4 extends PlayerAdapter {
    ...
    public PlayerAdapter1_20_R4(final VersionHandler1_20_R4 versionHandler, final Player player) {
        super(player.getUniqueId());
        this.bukkit = (CraftPlayer) player;
        this.minecraft = bukkit.getHandle();
        this.network = new PlayerNetwork1_20_R4(versionHandler.packetManager(), this);
    ...
    public int createAnvilMenu(final String name, final ItemStack itemStack) {
        ...
        final AnvilMenu menu = new AnvilMenu(minecraft.nextContainerCounter(), minecraft.getInventory(),
            MinecraftConstant1_20_R4.BETTER_NULL);
