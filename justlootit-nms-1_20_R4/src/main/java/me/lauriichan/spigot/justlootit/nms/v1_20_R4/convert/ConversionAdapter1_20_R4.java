...
import me.lauriichan.spigot.justlootit.nms.v1_20_R4.VersionHandler1_20_R4;
...
public final class ConversionAdapter1_20_R4 extends ConversionAdapter {

    static final CraftPersistentDataTypeRegistry DATA_TYPE_REGISTRY = NmsHelper1_20_R4.dataTypeRegistry();

    private final ISimpleLogger logger;
    private final VersionHandler1_20_R4 handler;

    public ConversionAdapter1_20_R4(VersionHandler1_20_R4 handler) {
        this.logger = handler.logger();
        this.handler = handler;
    }

    @Override
    public ProtoWorld1_20_R4 getWorld(File directory) {
        ...
        return handler.applyCapabilities(new ProtoWorld1_20_R4(workerPool(logger), logger,
