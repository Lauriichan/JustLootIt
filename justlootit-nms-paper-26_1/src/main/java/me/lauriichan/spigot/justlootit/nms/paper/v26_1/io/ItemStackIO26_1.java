...
public final class ItemStackIO26_1 extends NbtIO26_1<org.bukkit.inventory.ItemStack, CompoundTag> {

    public static final ItemStackIO26_1 ITEM_STACK = new ItemStackIO26_1();
    ...
    private final Frozen registry = NmsHelper26_1.getServer().registryAccess();

    private ItemStackIO26_1() {
