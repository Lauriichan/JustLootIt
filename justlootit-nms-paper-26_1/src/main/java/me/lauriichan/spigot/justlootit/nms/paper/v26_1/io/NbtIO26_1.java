package me.lauriichan.spigot.justlootit.nms.paper.v26_1.io;
...
public abstract class NbtIO26_1<E, N extends Tag> extends IOHandler<E> {
    ...
    public NbtIO26_1(final Class<E> type, final TagType<N> tagType) {
        super(type);
