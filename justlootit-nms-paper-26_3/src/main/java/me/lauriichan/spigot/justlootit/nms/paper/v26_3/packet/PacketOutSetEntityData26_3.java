package me.lauriichan.spigot.justlootit.nms.paper.v26_3.packet;
...
import me.lauriichan.spigot.justlootit.nms.paper.v26_3.model.EntityData26_3;
import me.lauriichan.spigot.justlootit.nms.paper.v26_3.model.ItemEntityData26_3;
...
public class PacketOutSetEntityData26_3 extends PacketOutSetEntityData {
    ...
    public PacketOutSetEntityData26_3(final ClientboundSetEntityDataPacket packet) {
        this.packet = packet;
        this.data = new EntityDataPack(packet.packedItems());
    }

    public PacketOutSetEntityData26_3(final ArgumentMap map) {
    ...
    private static class EntityDataPack implements IEntityDataPack {
        ...
        public EntityDataPack(final List<DataValue<?>> values) {
            ...
            for (final DataValue<?> value : values) {
                final EntityData26_3 data = EntityData26_3.create(value);
                if (data instanceof ItemEntityData26_3) {
                    dataValues.add(new ItemData(this, (ItemEntityData26_3) data));
                    continue;
                }
                dataValues.add(data);
            }
        ...
        private static class ItemData implements IItemEntityData {
            ...
            private final ItemEntityData26_3 data;

            public ItemData(final EntityDataPack pack, final ItemEntityData26_3 data) {
                this.pack = pack;
                this.data = data;
            }
