...
public class ItemEntityData26_3 extends EntityData26_3 implements IItemEntityData {
    ...
    ItemEntityData26_3(final DataValue<ItemStack> value) {
        this.value = value;
        this.itemStack = CraftItemStack.asBukkitMirror(value.value());
    }
