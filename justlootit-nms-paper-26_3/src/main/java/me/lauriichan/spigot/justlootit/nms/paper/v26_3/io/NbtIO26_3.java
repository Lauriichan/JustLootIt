package me.lauriichan.spigot.justlootit.nms.paper.v26_3.io;
...
public abstract class NbtIO26_3<E, N extends Tag> extends IOHandler<E> {
    ...
    public NbtIO26_3(final Class<E> type, final TagType<N> tagType) {
        super(type);
