...
public final class ItemStackIO26_3 extends NbtIO26_3<org.bukkit.inventory.ItemStack, CompoundTag> {

    public static final ItemStackIO26_3 ITEM_STACK = new ItemStackIO26_3();
    ...
    private final Frozen registry = NmsHelper26_3.getServer().registryAccess();

    private ItemStackIO26_3() {
    ...
    public org.bukkit.inventory.ItemStack fromNbt(final CompoundTag tag) {
        return CraftItemStack.asBukkitMirror(tag.isEmpty() ? ItemStack.EMPTY
