...
public final class CompoundTag26_3 implements ICompoundTag {

    private final CompoundTag compoundTag;

    public CompoundTag26_3() {
        this(new CompoundTag());
    }

    public CompoundTag26_3(CompoundTag compoundTag) {
    ...
    public ICompoundTag getCompound(String key) {
        ...
        return new CompoundTag26_3((CompoundTag) tag);
    }
    ...
    public IListTag<?> getList(String key) {
        ...
        return new ListTag26_3<>(listTag, TagType.getType(listTag.identifyRawElementType()));
    }
    ...
    public <T> IListTag<T> getList(String key, TagType<T> type) {
        ...
        if (listType == 0 || listType == type.tagId()) {
            return new ListTag26_3<>(listTag, type);
        }
        return null;
    }
    ...
    public void set(String key, ICompoundTag compound) {
        compoundTag.put(key, ((CompoundTag26_3) compound).handle());
    }

    @Override
    public void set(String key, IListTag<?> list) {
        compoundTag.put(key, ((ListTag26_3<?>) list).handle());
    }
    ...
    @Override
    public void clear() {
        NmsHelper26_3.clearCompound(compoundTag);
    }
